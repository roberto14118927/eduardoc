  ...
  grunt.initConfig({
    ...
    copy: {
      ...
      styles: {
        ...
        cwd: '<%= yeoman.client %>',
        dest: '.tmp/',
        src: ['{app,components,assets/css}/**/*.css']
      }
    },
...
concat:
  { generated:
  {
    files: [
      {
        dest: '.tmp/concat/app/assets-custom.js',
        src: ['<%= yeoman.client %>/assets/js/**/*.js', '!<%= yeoman.client %>/assets/js/**/*min.js'],
      }
    ]
  }
},
  ...
  { generated:
   { files:
      [ { dest: '<%= yeoman.dist %>/<%= yeoman.client %>/app/assets-custom.js',
        src: ['.tmp/concat/app/assets-custom.js']
      }
      ]
    }
  },
...
///TM
    injector: {
      ...
      scripts: {
        ...
        files: {
          '<%= yeoman.client %>/index.html': [
            [
              '<%= yeoman.client %>/{app,components,assets/js}/**/!(*.spec|*.mock).js',
              '!{.tmp,<%= yeoman.client %>}/app/app.{js,ts}',
              '!<%= yeoman.client %>/assets/js/jquery.min.js',
              '!<%= yeoman.client %>/assets/js/jquery-1.11.2.min.js',
              // '<%= yeoman.client %>/assets/js/materialize.js',
              // '<%= yeoman.client %>/assets/js/angular-materialize.js',
              // '<%= yeoman.client %>/assets/js/materialize-clockpicker/materialize.clockpicker.js',
              // '<%= yeoman.client %>/assets/js/materialize-colorpicker/materialize-colorpicker.js',
              // '<%= yeoman.client %>/assets/js/perfect-scrollbar/perfect-scrollbar.min.js',
              // '<%= yeoman.client %>/assets/js/plugins.js',
              // '<%= yeoman.client %>/assets/js/jquery-ui.min.js'
            ]
          ]
        }
      },
      ...
      css: {
        ...
        files: {
          '<%= yeoman.client %>/index.html': [
            '<%= yeoman.client %>/assets/css/materialize.css',
            '<%= yeoman.client %>/{app,assets/css,components}/**/*.css',
            '!<%= yeoman.client %>/assets/css/page-center/page-center.css'
          ]
        }
      }
    },
